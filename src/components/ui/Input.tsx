...
export const inputWrapperVariants = tv({
  base: "border border-input bg-transparent rounded-xl flex items-center gap-2 transition-colors focus-within:border-ring focus-within:ring-2 focus-within:ring-ring/20",
  variants: {
    size: {
      sm: "h-8 px-2",
      md: "h-10 px-3",
