    ...
    <div className="flex min-h-dvh w-full items-center justify-center bg-white shadow-[0_8px_40px_rgba(0,0,0,0.08)] p-6">
      ...
      >
        <motion.div
          ...
          className="flex min-h-0 w-full flex-col justify-center overflow-y-auto px-6 py-8 sm:px-12 md:w-[60%] md:px-10 lg:w-[45%] lg:px-16"
        >
          <Image
            src="/logo.svg"
            alt="ClinySOFT"
            width={139}
            height={27}
            className="mb-8 shrink-0 rounded-3xl"
            priority
            unoptimized
          />
